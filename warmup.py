# 启动机械臂，warmup
# 依赖文件：/home/cyt/ur5eControl/Servoj_RTDE_UR5
# 环境：ur5econtrol
# 将/home/cyt/ur5eControl/Servoj_RTDE_UR5/polyscope/translation_sample_servoj.urp文件导入polyscope
# polyscope是本地控制
# 启动顺序：运行该py-》运行urp-》点击继续
...
config_filename = curr_path + '/Servoj_RTDE_UR5/control_loop_configuration.xml'
FREQUENCY = 500
...
# planner
planner_0 = PathPlanTranslation(tcp,tcp, 10)
...
planner_5 = PathPlanTranslation(desired_pose_4, tcp, trajectory_time)

planners = [planner_0, planner_1, planner_2, planner_3, planner_4, planner_5]
